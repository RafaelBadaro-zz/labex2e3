...
CSV_FPATH = Path('/home/lucas.rotsen/Git_Repos/labex2/LABIII/csv_github')
METRICS_FPATH = Path('/home/lucas.rotsen/Git_Repos/labex2/LABIII/metrics')
...
def process_issues_csv(file):
    ...
    metrics = {
        'framework': name,
        'lifetime_median': [df['lifetime'].median()],
        'lifetime_mean': [df['lifetime'].mean()],
        'lifetime_stddev': [df['lifetime'].std()]
    }
